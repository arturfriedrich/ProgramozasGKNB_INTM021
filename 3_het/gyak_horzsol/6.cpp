...
int main() {
    ...
    do {
        cout << "\n Kérem a rendszámot: ";
        cin.getline(rsz,MAX); cout << endl;     // melyik tömböt töltse fel, annak a tömbnek mekkora a befogadóképessége (kiüríti a billentyűzetpuffert)
        hsz=strlen(rsz);                        // string length
        hsz>7 ? helyes=false : helyes=true;     // <feltétel> ? <ha igaz> : <ha hamis>
